...
public class DailyProgressChart extends View {

    private Paint linePaint, circlePaint, textPaint, bgPaint;
    private Map<String, Integer> data;
    private boolean isDarkMode = false;

    public DailyProgressChart(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private void init() {
        linePaint = new Paint();
        linePaint.setColor(Color.parseColor("#4CAF50")); // default green
        ...
        bgPaint = new Paint();
        bgPaint.setColor(Color.WHITE); // default background
    }
    ...
    public void setDarkMode(boolean darkMode) {
        ...
        if (isDarkMode) {
            ...
            linePaint.setColor(Color.parseColor("#76FF03")); // brighter green
            circlePaint.setColor(Color.parseColor("#76FF03"));
        } else {
